...
class Post(BaseModel):
    ...
    tags = Column(String(255), nullable=False, server_default=text("''"))
    ...
    preview_url = Column(String(255), nullable=False, server_default=text("''"))
    sample_url = Column(String(255), nullable=False, server_default=text("''"))
    jpeg_url = Column(String(255), nullable=False, server_default=text("''"))
...
def save_post(post_info):
    ...
    post = Post(id=post_info.get('id'), tags=post_info.get('tags'))
    post.author = post_info.get('author')
    post.source = post_info.get('source')
