...
def query_top_total_bookmarks(count=100000, min_id=91391283) -> list:
    cache_file = os.path.join(os.path.dirname(os.path.abspath(__file__)), r"cache\top_total_bookmarks-2022.json")
